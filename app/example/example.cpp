...
private:
    ...
    void createGraphicsPipeline()
    {
        ...
        auto vertShaderCode = readFile(rootPath + std::string("shaders/vert.spv"));
        auto fragShaderCode = readFile(rootPath + std::string("shaders/frag.spv"));
...
int main() 
{
    ...
    // https://github.com/MatthewBieda/VKEngine
