...
private:
    ...
    void createTextureImage()
    {
        ...
        stbi_uc* pixels = stbi_load(ROOT_PATHED("/data/textures/texture.jpg").c_str(), &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void createTextureSampler() 
    {
        ...
        // TODO: Set to VK_FALSE and 1.0f to disable
