...
void VulkanEngine::init_background_pipelines()
{
    ...
    if (!vkutil::load_shader_module(ROOT_PATH("/data/shaders/gradient_color.comp.spv").c_str(), _device, &gradientShader))
    {
        std::cerr << "Error when building the compute shader" << std::endl;
    }

    VkShaderModule skyShader;
    if (!vkutil::load_shader_module(ROOT_PATH("/data/shaders/sky.comp.spv").c_str(), _device, &skyShader))
    {
        std::cerr << "Error when building the compute shader" << std::endl;
    }
...
void VulkanEngine::init_triangle_pipeline()
{
    ...
    if (!vkutil::load_shader_module(ROOT_PATH("/data/shaders/colored_triangle.frag.spv").c_str(), _device, &triangleFragShader))
    {
        std::cerr << "Error when building the triangle fragment shader module" << std::endl;
    }
    else
    {
        std::cerr << "Triangle fragment shader succesfully loaded" << std::endl;
    }

    VkShaderModule triangleVertexShader;
    if (!vkutil::load_shader_module(ROOT_PATH("/data/shaders/colored_triangle.vert.spv").c_str(), _device, &triangleVertexShader))
    {
        std::cerr << "Error when building the triangle vertex shader module" << std::endl;
    }
    else
    {
        std::cerr << "Triangle vertex shader succesfully loaded" << std::endl;
    }
...
void VulkanEngine::init_mesh_pipeline()
{
    ...
    VkShaderModule triangleVertexShader;
    if (!vkutil::load_shader_module(ROOT_PATH("/data/shaders/colored_triangle_mesh.vert.spv").c_str(), _device, &triangleVertexShader))
    {
        std::cerr << "Error when building the triangle vertex shader module" << std::endl;
    }
    else
